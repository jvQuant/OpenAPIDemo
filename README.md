#现已支持沪深全市场(包含可转债)Leve2逐笔成交行情接入，支持券商低延时交易接口调用。

[level2行情在线测试](http://jvquant.com/websocket.html) http://jvquant.com/websocket.html

[在线交易测试](http://jvquant.com/trade.html) http://jvquant.com/trade.html
...
| 5.4 | hold\_list\[x\].usable\_vol | string | 可用数量 |
| 5.5 | hold\_list\[x\].day\_earn | string | 当日盈亏 |
| 5.6 | hold\_list\[x\].hold\_earn | string | 持仓盈亏 |
...
[在线测试](http://jvquant.com/trade.html)
...
[在线测试](http://jvquant.com/websocket.html)
